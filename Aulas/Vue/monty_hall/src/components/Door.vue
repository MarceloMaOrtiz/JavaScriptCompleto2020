<template>
    <div class="door-area">
        <!--
            ...
            A verificação faz com que selected não funcione caso a porta esteja aberta
        -->
        ...
        <div class="door" :class="{ open }"
            ...
            <!--
                .stop é uma forma de parar eventos existentes, nesse caso, antes do click para
                abrir a porta, havia o click na porta que selecionava os elementos, com stop
                não irá mais selecionar quando clicar no knob
            -->
...
.door-frame {
    ...
    display: flex;
    justify-content: center;
    /* Posiciona o Gift na parte de baixo */
