...
const cloneObjeto = function(objeto) {
    ...
    for (let i = 0; i < keys.length; i++){
        newObjeto[keys[i]] = values[i]
    }
    return newObjeto

}

const removerPropriedade = function (objeto, campo){
    delete objeto[campo]
    return objeto
}
...
console.log(objeto)
console.log(removerPropriedade(cloneObjeto(objeto), "a"))
console.log(Object.is(removerPropriedade(cloneObjeto(objeto), "a"), objeto))
console.log(objeto)